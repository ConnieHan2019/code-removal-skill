...
> **non-active warning**: Do not treat this file as the current execution instructions. For day-to-day operation, `../agent-orchestration-workflow.md`, `../supervisor-checklist.md`, `../removal-list-template.md`, and `../blind-review-prompt.md` are authoritative.
